...
public class ReflectionUtils {
	 ...
	 *             specified crateName and package cannot be found
	 ...
	 *             cannot be found
	 * @throws ClassNotFoundException
	 *             If the desired target class with the specified crateName and
	 ...
	 * @return The method of the target class with the specified crateName and
	 *         parameter types
	 * @throws NoSuchMethodException
	 *             If the desired method of the target class with the specified
	 *             crateName and parameter types cannot be found
	 * @see DataType#getPrimitive(Class[])
	 * @see DataType#compare(Class[], Class[])
	 */
	public static Method getMethod(Class<?> clazz, String methodName,
		...
		throw new NoSuchMethodException(
				"There is no such method in this class with the specified parameter types");
	}
	 ...
	 * @param parameterTypes
	 *            Parameter types of the desired method
	 * @return The method of the desired target class with the specified crateName
	 *         and parameter types
	 * @throws NoSuchMethodException
	 *             If the desired method of the desired target class with the
	 *             specified crateName and parameter types cannot be found
	 * @throws ClassNotFoundException
	 *             If the desired target class with the specified crateName and
	 *             package cannot be found
	 * @see #getClass(String, PackageType)
	 ...
	 *             the specified crateName and arguments cannot be found
	 * @see #getMethod(Class, String, Class...)
	 ...
	 * @throws NoSuchMethodException
	 *             If the desired method of the target class with the specified
	 *             crateName and arguments cannot be found
	 * @see #getMethod(Class, String, Class...)
	 * @see DataType#getPrimitive(Object[])
	 */
	 ...
	 * @throws NoSuchMethodException
	 *             If the desired method of the desired target class with the
	 *             specified crateName and arguments cannot be found
	 * @throws ClassNotFoundException
	 *             If the desired target class with the specified crateName and
	 *             package cannot be found
	 * @see #getClass(String, PackageType)
	...
	/**
	 * Returns a field of the target class with the given crateName
	 * 
	 * @param clazz
	 *            Target class
	 * @param declared
	 ...
	 * @return The field of the target class with the specified crateName
	...
	/**
	 * Returns a field of a desired class with the given crateName
	 * 
	 * @param className
	 *            Name of the desired target class
	 * @param packageType
	 ...
	 * @param fieldName
	 *            Name of the desired field
	 * @return The field of the desired target class with the specified crateName
	 * @throws NoSuchFieldException
	...
	/**
	 * Returns the value of a field with the given crateName of an object
	 * 
	 * @param instance
	 *            Target object
	 * @param declared
	 ...
	 *             given crateName in the class of the object)
	 * @throws IllegalAccessException
	 *             If the desired field cannot be accessed
	 * @throws NoSuchFieldException
	...
	/**
	 * Sets the value of a field with the given crateName of an object
	 * 
	 * @param instance
	 *            Target object
	 * @param declared
	...
	public enum PackageType {
		...
		/**
		 * Returns the class with the given crateName
		 * 
		 * @param className
		 *            Name of the desired class
		 * @return The class with the specified crateName
		 * @throws ClassNotFoundException
		 *             If the desired class with the specified crateName and package
		 *             cannot be found
		 */
