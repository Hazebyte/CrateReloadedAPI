...
public interface Messages {
  ...
  String RELOAD = "The plugin has been reloaded. Please note that this command may cause unintended behavior. If you encounter any issues, please restart the server.";
